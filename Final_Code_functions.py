...
def return_shadow_parameters(Image_Location_Interface, Image_Location_PostProcess):
    ...
    # direction of step can be used to create a unimodal distribution around 0 if we have enough undercuts from many images, but now we will not take it into consideation due to lack of data points needed for this
